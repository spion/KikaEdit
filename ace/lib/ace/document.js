...
(function() {
    ...
    this.fireEditEvent = function(data) {
        this.$dispatchEvent("edit", {data:data})
    }
    ...
    this.$insertLines = function(row, lines, fromUndo) {
        ...
        if (!fromUndo && this.$undoManager) {
            ...
            this.$deltas.push(newDelta);
            this.fireEditEvent(newDelta);
    ...
    this.$insert = function(position, text, fromUndo) {
        ...
        if (!fromUndo && this.$undoManager) {
            ...
            this.$deltas.push(deltaNew);
            this.fireEditEvent(deltaNew);
            this.$informUndoManager.schedule();
        }

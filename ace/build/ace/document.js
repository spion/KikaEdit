  ...
  (function() {
    ...
    this.$insertLines = function(a, b, c) {
      if(b.length != 0) {
        ...
        if(!c && this.$undoManager) {
          ...
          a = {action:"insertText", range:new h(a, 0, a + b.length, 0), text:b.join(c) + c};
          this.$deltas.push(a);
    ...
    this.$insert = function(a, b, c) {
      ...
      if(this.$isNewLine(b)) {
        ...
        a = {action:"insertText", range:h.fromPoints(a, d), text:b};
        this.$deltas.push(a);
        this.fireEditEvent(a);
        this.$informUndoManager.schedule()
      }return d
    ...
    this.$remove = function(a, b) {
      if(!a.isEmpty()) {
        if(!b && this.$undoManager) {
          ...
          b = {action:"removeText", range:a.clone(), text:this.getTextRange(a)};
          this.$deltas.push(b);
          this.fireEditEvent(b);
          this.$informUndoManager.schedule()
        }this.modified = true;
        b = a.start.row;
